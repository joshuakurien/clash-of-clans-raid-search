...
def plot_results_multiple_neighborhoods (neighborhood_list, cost_function: Callable, 
    ...
    for neighborhood in neighborhood_list:
        ...
        optimization_path_label = "Optimization path - " + str(counter)
        best_solution_label = "Best solution - " + str(counter)

        # Plot the optimization path
        ax.plot(x1_history, x2_history, cost_history, marker='o', linestyle='-', color='red', label=optimization_path_label)
        ax.plot(best_x[0], best_x[1], best_cost, marker='o', linestyle='-', color='blue', label=best_solution_label)
    ...
    ax.set_ylabel('x2')
    ax.set_zlabel('Cost')
    ax.set_title('Cost function and optimization in neighborhoods (3D)')
    plt.legend()
    plt.show()
    ...
    for neighborhood in neighborhood_list:
        ...
        plt.plot(x1_history, x2_history, c='red', marker='o', linestyle='-', label=optimization_path_label)
        plt.plot(best_x[0], best_x[1], c='blue', marker='o', linestyle='-', label=best_solution_label)
